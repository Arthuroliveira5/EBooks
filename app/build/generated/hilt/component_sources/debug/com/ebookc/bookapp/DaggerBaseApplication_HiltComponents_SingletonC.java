...
import com.ebookc.bookapp.data.di.HiltModule_ProvideAllBookRepoFactory;
import com.ebookc.bookapp.data.di.HiltModule_ProvideRealtimeDatabaseFactory;
import com.ebookc.bookapp.domain.repo.AllBookRepo;
import com.ebookc.bookapp.presentation.ViewModel;
import com.ebookc.bookapp.presentation.ViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerBaseApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends BaseApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return ImmutableSet.<String>of(ViewModel_HiltModules_KeyModule_ProvideFactory.provide());
    }
  ...
  private static final class ViewModelCImpl extends BaseApplication_HiltComponents.ViewModelC {
    ...
    @Override
    public Map<String, javax.inject.Provider<androidx.lifecycle.ViewModel>> getHiltViewModelMap() {
      return ImmutableMap.<String, javax.inject.Provider<androidx.lifecycle.ViewModel>>of("com.ebookc.bookapp.presentation.ViewModel", ((Provider) viewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.ebookc.bookapp.presentation.ViewModel 
          return (T) new ViewModel(singletonCImpl.provideAllBookRepoProvider.get());
  ...
  private static final class SingletonCImpl extends BaseApplication_HiltComponents.SingletonC {
    ...
    private Provider<FirebaseDatabase> provideRealtimeDatabaseProvider;

    private Provider<AllBookRepo> provideAllBookRepoProvider;
    ...
    private void initialize() {
      this.provideRealtimeDatabaseProvider = DoubleCheck.provider(new SwitchingProvider<FirebaseDatabase>(singletonCImpl, 1));
      this.provideAllBookRepoProvider = DoubleCheck.provider(new SwitchingProvider<AllBookRepo>(singletonCImpl, 0));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.ebookc.bookapp.domain.repo.AllBookRepo 
          return (T) HiltModule_ProvideAllBookRepoFactory.provideAllBookRepo(singletonCImpl.provideRealtimeDatabaseProvider.get());

          case 1: // com.google.firebase.database.FirebaseDatabase 
          return (T) HiltModule_ProvideRealtimeDatabaseFactory.provideRealtimeDatabase();
